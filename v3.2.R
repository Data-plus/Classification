...
conv_pool_cnn <- keras_model_sequential() %>%
  ...
  layer_conv_1d(filters = 24, kernel_size = 1) %>%
...
testing_labels_final1 <- write.table(doc, "C:/Users/abcd0/Documents/Uni/2018-2/FIT5149 Applied Data Analysis/Assignment/testing_labels_final1.txt", sep="\n", row.names = FALSE, quote = FALSE, col.names = FALSE)
